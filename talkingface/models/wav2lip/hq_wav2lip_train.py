            ...
            if global_step % hparams.eval_interval == 0:
                with torch.no_grad():
                    ...
                    if average_sync_loss <= best_loss:
                        ...
                        save_checkpoint(
                            disc, disc_optimizer, global_step, checkpoint_dir, global_epoch, prefix='disc_', is_best=True)
...
if __name__ == "__main__":
    ...
    disc_lr_scheduler = WarmupPolyLR(disc_optimizer, warmup_iters=500, max_iters=200000)
